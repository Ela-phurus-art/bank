...
const approvalModuleRouter = {
  ...
  children: [
    ...
    {
      path: 'AnnualFeeRuleReview',
      component: () => import('@/views/approvalModule/AnnualFeeRuleReview'),
      name: 'AnnualFeeRuleReview',
      // menus: 'resourceManage',
      meta: { title: '年费审核规则复核' },
      hidden: false
    },
    {
      path: 'InterestExpenseLimitReview',
      component: () => import('@/views/approvalModule/InterestExpenseLimitReview'),
      name: 'InterestExpenseLimitReview',
      // menus: 'resourceManage',
      meta: { title: '息费审核规则复核' },
      hidden: false
    },
